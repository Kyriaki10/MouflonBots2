...
public class blue extends RobotAuto {
    ...
    private void autoTest() {
        switch (autonomousState) {
            ...
            case 8:
                ...
                break;
            case 9:
                if (autoTimer.seconds() >= 0.3 && targetReached()) {
            ...
            case 10:
                ...
                break;
            case 11:
                if (targetReached() && Math.abs(cascade.getCurrentPosition() - cascadeUp) < 3000 && autoTimer.seconds() >= 0.3) {
                    cascadeDump.setPosition(dumpDeposit);
                    autoTimer.reset();
